...
const DEFAULT_STATE: AppState = {
  ...
  products: [
    ...
    { id: '2', name: 'FaceID Gate Lock X2', price: 2499.00, stock: 12, category: 'Gate Locks', sku: 'GL-X2', image: 'https://images.unsplash.com/photo-1558002038-1055907df827?auto=format&fit=crop&q=80&w=400', salesCount: 89 },
    { id: '3', name: 'TOTO Padlock Lite', price: 199.00, stock: 0, category: 'Padlocks', sku: 'PL-LITE', image: 'https://images.unsplash.com/photo-1558002038-1055907df827?auto=format&fit=crop&q=80&w=400', salesCount: 1200 },
  ],
  conversations: [
    { 
    ...
    { 
      id: '2', customerName: 'Sarah Lim', customerPhone: '+60 11-234 5678', platform: 'instagram', lastMessage: 'Price for A100 Pro?', lastTimestamp: '09:15 AM', unreadCount: 0, isHumanTakeover: true, assignedStaff: 'Agent Sarah', assignedAt: new Date(Date.now() - 3600000).toISOString(), firstResponseAt: new Date(Date.now() - 3000000).toISOString(), isOpenedByStaff: true, priority: 'medium', status: 'active', aiEnabled: false,
